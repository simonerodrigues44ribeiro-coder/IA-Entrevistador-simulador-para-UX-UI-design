...
Perguntas Técnicas (Sobre o Trabalho)
​1. "Como o seu background no desenho manual influencia o seu processo de criação de interfaces digitais (UI)?"
​"O desenho manual me deu uma base sólida em proporção, teoria das cores e composição. No digital, eu uso isso para criar layouts equilibrados. Meu diferencial é que eu começo rabiscando no papel (wireframe), o que me permite testar ideias mais rápido antes de ir para o Figma."
​2. "Se um usuário tiver dificuldade em entender onde clicar em um aplicativo que você desenhou, o que você faria para resolver?"
​"Eu aplicaria testes de usabilidade. Observaria onde ele se confunde e ajustaria o contraste visual ou o tamanho dos botões. No design, a clareza vem antes da beleza; o desenho deve guiar o usuário de forma intuitiva."
​3. "O que você considera mais importante ao escolher uma paleta de cores para um aplicativo de banco, por exemplo?"
​"A acessibilidade e a psicologia das cores. Para um banco, cores que transmitem confiança e segurança são essenciais. Além disso, eu garantiria que o contraste fosse alto o suficiente para que pessoas com deficiência visual pudessem ler tudo sem esforço."
​🤝 Perguntas Comportamentais (Sobre ela)
​4. "Você está começando agora na tecnologia vindo de uma área artística. Como você lida com críticas ao seu desenho ou design?"
